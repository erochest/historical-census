	...
	<fo:table-column 
	  ...
	  <fo:table-body>
		...
		<fo:table-cell border="solid black 1px" padding="1em" number-rows-spanned="3">
        		<fo:block> 
 				<fo:external-graphic src="url(http://lewis.lib.virginia.edu/censusmap/testpdf/huscomap2.png)"/>
			</fo:block> 
		</fo:table-cell>
		...
		<fo:table-cell>
        		<fo:block text-align="center"> 
 				<fo:external-graphic src="url(http://lewis.lib.virginia.edu/censusmap/testpdf/maplegend2.png)"/>  
			</fo:block> 
		</fo:table-cell>
	     </fo:table-row>
	     <fo:table-row>
