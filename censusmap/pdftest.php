...
URL=http://lewis.lib.virginia.edu/cgi-local/censusmapbin/dbfconvert.pl?pid=$pid&variable=$var&label=$label&stateid=$stateid&geolevel=$geolevel&year=$year&statename=$statename\">";
