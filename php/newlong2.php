...
print_template($link, $varname, $begin, $end);

function print_template ($link, $varname, $begin, $end) {
    ...
    printbody($link, $varname, $begin, $end);
...
function printbody($link, $varname, $begin, $end) {
    ...
    $formulas = array(
        "1790" => $F1790, "1800" => $F1800, "1810" => $F1810, "1820" => $F1820, "1830" => $F1830, "1840" => $F1840,
 ...
 */
    $column       = "Y$end";
    $state_query  = "Select stateid, name from Geography "
        . "where st_cnty='S' and $column=1 order by statecode";
    $state_rows   = query_fetch_all($link, $state_query);
    $statelist    = array();
