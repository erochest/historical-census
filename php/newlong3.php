...
print_template($link, $var, $begin, $end, $stateids, $allstates, $valid);

function print_template(
    $link, $var, $begin, $end, $stateids, $allstates, $valid
) {
    ...
    printbody($link, $var, $begin, $end, $stateids, $allstates, $valid);
...
function printbody($link, $var, $begin, $end, $stateids, $allstates, $valid) {
    ...
    $query  = "Select * from Vars where varname='"
 ...
 */
    ...
    $fields = array(
        "1790" => $V1790, "1800" => $V1800, "1810" => $V1810, "1820" => $V1820, "1830" => $V1830, "1840" => $V1840,
 ...
 */
    ...
    case 'ALL':
        ...
        $x       = 1;
        $column  = "Y$end";
        $query3  = "Select name, stateid, statecode from Geography "
            . "where st_cnty = 'C' and $column=1 order by statecode, name";
        ...
        foreach ($rows as $row) {
            ...
            while ($begin<=$end) {
                $query2="Select ${fields[$begin]} "
                    . "where stateid="
                    . mysqli_real_escape_string($link, $stateid)
                    . " and st_cnty='C' and name='"
                    . mysqli_real_escape_string($link, $area)
                    . "'";
                $row2 = query_fetch_one($link, $query2);
 ...
 */
    ...
    case '':
        foreach ($stateids as $stateid) {
            $savebegin=$begin;
            print "<div class=\"indent5em\">"
                . "<table border=\"1\"><tr>"
                . "<th colspan=\"19\">${abbrev[$stateid]}: $var</th></tr>"
                . "<tr><th>County</th>";
            $window = rand();
            $label  = "";
            while ($begin<=$end) {
                ...
                $header="<th>$begin<br />"
                    ...
                    . "window.open('/censusmap/map2.php?"
                    . "statename=${abbrev[$stateid]}&year=$begin"
                    . "&long=$var&label=$var&stateid=$stateid"
                    . "&geolevel=state_by_county','$window','$width');\">
                    <img src=\"/gifs/mapbutton.gif\" border=\"0\"/></a></th>";
                print "$header";
                $label .= $header;
                $begin  = $begin + 10;
            ...
            $x=1;
            $query3="Select name from Geography "
                . "where stateid="
                . mysqli_real_escape_string($link, $stateid)
                . " and st_cnty='C' order by name";
            $rows3 = query_fetch_all($link, $query3);
